...
<div id="slider" class="small-size">
        ...
        <ul class="slides">
            ...
            <li>
            	<?php if (strlen($video) > 1) { // Embedding video 
 					$video = embed_fix($video,700,450); // add wmode=transparent to iframe/embed
 					?>
					
					<div class="cover"><?php echo "$video"; ?></div>
					
					<?php } else {
 						get_the_image( array( 'size' => 'featured-small', 'width' => 700, 'height' => 450 ) );
						?>
